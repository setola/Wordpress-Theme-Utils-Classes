...
class HtmlHelper extends HtmlBuilder {
    ...
    /**
     * Retrieves a <select> tag
     * @param string $name the input name
     * @param array $options list of options array(array('Label1'=>'value1'), array('Label2'=>'value2');
     * @param array $parms additional parameters
     * @return string html markup
     */
    public static function select($name, array $options, $parms = array()) {
        $parms['name'] = $name;
        $value = isset($parms['value']) ? $parms['value'] : '';
        unset($parms['value']);
        $inner_html = '';
        $option_parms = array();
        ...
        return self::standard_tag('select', $inner_html, $parms);
    }
